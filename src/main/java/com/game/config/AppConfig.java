...
public class AppConfig {
    ...
    private Properties additionalProperties() {
        ...
        properties.setProperty("server.servlet.encoding.charset", "UTF-8");
        properties.setProperty("server.servlet.encoding.enabled", "true");
        properties.setProperty("server.servlet.encoding.force", "true");
        return properties;
    }
}